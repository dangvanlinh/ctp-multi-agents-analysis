...
- Coin out: BuyRollGift chiếm 20.1% total coin out (T3/2026)
- Rev estimate: ~216M/tháng
- SKB + CHĐ gộp = ~556M/tháng → >1/3 tổng rev game
- Là driver chính khiến whale nạp GEM

## Backlog (cần điều tra thêm)
- [ ] SKB PU breakdown theo user age
- [ ] SKB conversion funnel: bao nhiêu user chơi event vs bao nhiêu nạp
- [ ] Pity rate: bao nhiêu % user hit pity vs lucky pull
